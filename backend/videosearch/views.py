    ...
    def get(self, request, *args, **kwargs):
        ...
        for row in query_job:
            data.append({'name': row[1], 
                            'etiqueta':row[0],
                            'url_video': 'storage.cloud.google.com/videosearch/'+row[1]+'.mp4',
                            'url_gif': 'storage.cloud.google.com/video-gifs/'+row[1]+'.gif',
                            'url_image':'storage.cloud.google.com/video-thumbs/'+row[1]+'.png'})
